...
Test History helps you review the historical performance of individual tests across different runs and branches. You can view this data by branch, chart, or list.

{% embed url="https://player.mux.com/Nkr100jOgrd1hCuml71jghMb4VK02Y6mXCFMixHDFldHc?min-resolution=1080p" %}
Test History View
{% endembed %}
...
* <mark style="color:green;">green</mark> - passed
...
Toggle **Merge Branches** to display a consolidated timeline across all branches.
