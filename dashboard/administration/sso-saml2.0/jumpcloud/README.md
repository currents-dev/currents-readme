...
* Fill in the fields according the values defined in [saml2.0-configuration.md](../saml2.0-configuration.md "mention")
  * SP Entity ID
  * ACS URL
  * SAMLSubject NameID
  * SAMLSubject NameID Format
  * Signature Algorithm: RSA-SHA256
  * Login URL: you will be able to define the login URL after Currents support team activated the integration. See [idp-initiated-sessions.md](../idp-initiated-sessions.md "mention").
...
* Submit the Metadata XML file and the organization's email domains from the dashboard — see [setting-up-sso.md](../setting-up-sso.md "mention"). The values the SAML application itself needs are in [saml2.0-configuration.md](../saml2.0-configuration.md "mention").
