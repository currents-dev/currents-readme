...
SCIM is requested alongside SSO: select **Also set up SCIM provisioning** in step 3 of [setting-up-sso.md](setting-up-sso.md "mention"), and the same request covers both.
