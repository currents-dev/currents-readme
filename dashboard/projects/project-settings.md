...
* **Appearance**: The icon, accent color and labels shown for this project across the sidebar, project switcher and project lists. Changes here save immediately, unlike edits in [Manage Projects](../administration/manage-projects.md), which are held as a draft; the **Organize Projects** link beside the field opens that editor. Only Admins can edit them; other roles see them read-only.
