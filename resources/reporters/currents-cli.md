...
Learn more about obtaining a [record-key.md](../../guides/record-key.md "mention") and generating a [ci-build-id.md](../../guides/parallelization-guide/ci-build-id.md "mention")
