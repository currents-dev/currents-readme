...
The package also provides additional fixtures for enhacing the Playwright test run, like [Code Coverage](../../../guides/coverage/code-coverage-for-playwright.md), and [Rules Automation](../../../guides/currents-actions/setup-currents-actions.md).
