...
{% hint style="info" %}
**Orchestration** uses `pwc-p discover` and `pwc-p run`. See [playwright-orchestration.md](../../../guides/ci-optimization/playwright-orchestration.md "mention"). Still on legacy? See [playwright-orchestration-v1.md](../../../guides/ci-optimization/playwright-orchestration-v1.md "mention"). The options below apply to `pwc-p run` where noted.
{% endhint %}
